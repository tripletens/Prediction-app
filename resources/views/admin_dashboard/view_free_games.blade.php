                                            ...
                                            <td>
                                                <form method="POST" action="/admin/games/update_result/{{ $item_y->category }}/{{ $item_y->game_type }}/{{ $item_y->id }}">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" name="result_a" placeholder="{{ $item->team_a }}'s Score">
                                                        <input type="number" class="form-control" name="result_b" placeholder="{{ $item->team_b }}'s Score">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="/admin/games/update_result/{{ $item_d->category }}/{{ $item_d->game_type }}/{{ $item_d->id }}">
                                                    {{ csrf_field() }}
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" name="result_a" min="0" placeholder="{{ $item_d->team_a }}'s score">
                                                        <input type="number" class="form-control" name="result_b" min="0" placeholder="{{ $item_d->team_b }}'s score">
                                                        <input type="submit" value="Add" class="btn btn-success">
                                                    </div>
                                                </form>
                                            </td>
